...
public class SIzquierda extends Figura {

    /*Posiciones:
    * 0 Cuadrado de Izquierda        *
    * 1 Cuadrado de Centro Ariba       *
    * 2 Cuadrado de Centro Abajo       *
    ...
    */
    ...
    public void rotar(int[][] logica) {
        ...
        switch (estado) {
            case 0:
                coordenadas.add(new int[]{Posiciones[0][0]-1, Posiciones[0][1] + 2});
